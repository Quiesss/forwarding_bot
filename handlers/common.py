...
async def cmd_start(message: Message):
    pin = await message.answer('‼️Отправляйте сюда свое тз в строго следующем формате: \n\n'
                               ...
                               '<b>Ссылка на оффер</b> - ссылка на оффер из партнерской сети \n'
                               '<b>Серверный пиксель</b> - + или -, в зависимости от того, нужен вам серверный или '
                               'обычный \n'
                               '<b>Если вы прикрепляете несколько файлов, обязательно группируйте их в альбом</b> \n\n'
                               '<b>Гео: \n'
                               'Название ПП: \n'
                               'Метка: \n'
                               'Код доступа: \n'
